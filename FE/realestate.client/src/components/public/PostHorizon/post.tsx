...
const PostHorizon = ({ data, option, loading }: { data?: any, option?: number, loading?: boolean }) => {
    ...
    if (option === OptionConst.NORMAL) {
        return <div style={{ width: "720px", height: '162px' }}>
            <Flex>
                <div style={{ flex: 3 }}>
                ...
                <div style={{ flex: 7 }}>
                    <h3 style={{ color: '#444' }}>BÁN NHÀ SÀI ĐỒNG, LONG BIÊN 112M2, 5 TẦNG, MẶT TIỀN 5M, GARA, THANG MÁY, Ô TÔ TRÁNH, 2 THOÁNG</h3>
        ...
        <LabelCardHorizon text={labelText} color={color}>
            <div style={{ width: "720px", height: '162px' }}>
                <Flex>
                    ...
                    <div style={{ flex: 7 }}>
                        <h3>BÁN NHÀ SÀI ĐỒNG, LONG BIÊN 112M2, 5 TẦNG, MẶT TIỀN 5M, GARA, THANG MÁY, Ô TÔ TRÁNH, 2 THOÁNG</h3>

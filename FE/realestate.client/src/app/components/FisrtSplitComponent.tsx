        ...
        <>
            <Flex justify="space-between">
                <div style={{ background: "#fff", padding: "7px 15px 25px 15px", margin: "20px 0", borderRadius: "2px" }}>
                    <h2 style={{ marginBottom: "12px", fontSize: "18px" }}>Cho thuê</h2>
                ...
                <div style={{ background: "#fff", padding: "12px 15px 10px 15px", margin: "20px 0", borderRadius: "2px" }}>
                    <h2 style={{ marginBottom: "12px", fontSize: "18px" }}>Mua bán</h2>
                    <Flex gap="middle">
                ...
                <div style={{ background: "#fff", padding: "12px 15px 10px 15px", margin: "20px 0", borderRadius: "2px" }}>
                    <h2 style={{ marginBottom: "12px", fontSize: "18px" }}>Sang nhượng</h2>
                    <Flex gap="middle">

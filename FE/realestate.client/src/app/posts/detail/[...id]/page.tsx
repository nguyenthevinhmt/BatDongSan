    ...
    const items: MenuProps['items']= [
        {
            label: <Link href="https://www.facebook.com">
                 <Image preview={false} src={facebook_icon.src} style={{
                                    width:"40px",
                                    
                                    marginBottom:"2px", 
                                    height:"23px"}} />Facebook</Link>,
            key: '0',
        },
        {
            ...
            >
                <Flex justify="space-between">
                    <div className="box_left" style={{width:'730px'}}>
                        ...
                        <h1 style={{fontSize:"24px",color:"#2C2C2C", margin:"10px 0", color:"#2C2C2C"}}>Chính chủ bán 2 lô đất cực đẹp giá đầu tư tại Sơn Mỹ, Hàm Tân - chỉ hơn 2tr/m2, sổ hồng đầy đủ</h1>

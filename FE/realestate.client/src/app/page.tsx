            ...
            <div style={{ width: "100%", height: "100vh", backgroundColor: "#F4F4F4" }}>
                ...
                <Layout style={{ margin: "0 auto", maxWidth: "1340px", minWidth: "1340px", backgroundColor: "#F4F4F4", padding: "0 167px" }}>
                    ...
                    <div>
                        ...
                        <p style={{ fontFamily: "Arial,Helvetica,sans-serif", fontSize: "24px", fontWeight: "600", textAlign: "center", color: "#333" }}>
                        ...
                        <Flex justify="space-between" style={{ margin: "20px 0" }}>
                            ...
                            <Card
                                hoverable
                                style={{ width: 240 }}
                                cover={<Image alt="example" width={350} height={200} src={danang} />}>
                                <p style={{ textAlign: "center", color: "#1266DD", fontSize: "15px", fontWeight: "700" }}>Thành phố Đà Nẵng</p>
                            </Card>
                            <Card
                                hoverable
                                style={{ width: 240 }}
                                cover={<Image alt="example" width={350} height={200} src={HCM} />}>
                                <p style={{ textAlign: "center", color: "#1266DD", fontSize: "15px", fontWeight: "700" }}>Thành phố Hồ Chí Minh</p>
                            </Card>
                        </Flex>
                    </div>
                    <FisrtSplitComponent />

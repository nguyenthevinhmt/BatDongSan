    ...
    if (publicId) {
      if (listMediaId.includes(file.uid)) {
        ...
        setListMedia((prevUrls) =>
          prevUrls.filter(
            (url) =>
              url.name !== file.name.replace(/\.\w+$/, "") &&
              url.description !== file.secure_url
          )
        );
      }
    }
              ...
              <Flex justify="center" gap={"small"}>
                ...
                >
                  <Select
                    ...
                    disabled={
                      isDisableSelect.districtDisable || !(edit && isChange)
                    }
              ...
              <Flex justify="center" gap={"small"}>
                ...
                >
                  <Select
                    ...
                    disabled={
                      isDisableSelect.wardDisable || !(edit && isChange)
                    }
              ...
              >
                ...
                <Flex justify="center" gap={"small"}>
                  ...
                  >
                    <InputNumber
                      disabled={
                        currentCalculateType === 3 || !(edit && isChange)
                      }
                      style={{
                        width: "100%",
                      }}
                  ...
                  rules={[
                    {
                      validator: (_, value) =>
                        fileList.length > 0
                          ? Promise.resolve()
                          : Promise.reject(
                              new Error("Vui lòng thêm ít nhất 1 ảnh")
                            ),
                    },
                  ]}
                >
                ...
                edit ? (
                  ...
                  >
                    ...
                    >
                            ...
                            <Button
                              ...
                              onClick={() => {
                                Modal.confirm({
                                  ...
                                  content:
                                    "Các thay đổi của bạn sẽ được lưu và không thể hoàn tác.",
                                  okText: "Đồng ý",
                                  cancelText: "Hủy",
                                  onOk() {
                      ...
                      {status === postStatus.POSTED ||
                      status === postStatus.PENDING || status === postStatus.UNPOSTED? (
                        <></>
                      ) : (
                        <Form.Item>
                          <Button

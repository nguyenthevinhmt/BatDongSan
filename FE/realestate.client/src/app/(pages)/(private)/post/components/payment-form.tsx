...
import { Button, Card, DatePicker, Divider, Flex, Form, InputNumber, Radio } from "antd";
                ...
                >
                                ...
                                {postInfo?.map((item) => (
                                        ...
                                        style={{
                                            ...
                                            border:
                                                item.option === formData.options
                                                    ...
                                                    : "1px solid #ccc",
                                            backgroundColor:
                                                item.option === formData.options ? "#E8FEFF" : "#ffffff",
                                        }}
                                        onClick={() => {
                                    ...
                                    >
                                        <p style={{ fontSize: "16px", fontWeight: "500" }}>
                                            ...
                                            {item.option === 2 && <span style={{ color: '#009BA1' }}>VIP bạc</span>}
                                            {item.option === 3 && <span style={{ color: '#E3AA49' }}>VIP Vàng</span>}
                                            {item.option === 4 && <span style={{ color: '#E03C31' }}>VIP bạc</span>}
                                        </p>
                                        ...
                                        <Button
                                            style={{
                                                marginTop: "30px",
                                                color: item.option === formData.options ? "#fff" : "rgb(134 219 222)",
                                                border: "1px solid rgb(134 219 222)",
                                                backgroundColor:
                                                    item.option === formData.options ? "#009BA1" : "#ffffff",
                                            }}
                                        >
                    ...
                    <div style={{ marginTop: "20px" }}>
                        ...
                        <div style={{ width: "30%", marginLeft: '10px' }}>
                            <p style={{ fontWeight: "400", marginBottom: "10px", marginTop: '10px' }}>
                        ...
                        >
                                ...
                                <DatePicker
                                    ...
                                    onChange={(value, dateString) => {
                                        setFormData((prev: any) => {
                                            return {
                                                ...prev,
                                                postStartDate: new Date(dayjs(value, "YYYY/MM/DD").toDate()),
                                                postEndDate: new Date(dayjs(value, "YYYY/MM/DD").add(formData.lifeTime, 'day').toDate())
                                            }
                                        })
                                    }}
                            ...
                            <div style={{ width: "50%", marginLeft: "10px" }}>
                                ...
                                <DatePicker
                                    ...
                                    format="DD/MM/YYYY"
                                    disabled={true}
                                    value={dayjs(formData.postStartDate).add(formData.lifeTime, "day")}
                                />
                            </div>
                        </Flex>
                    </div>
                    ...
                    <div style={{ marginTop: "20px" }}>
                        ...
                        >
                            <div>Loại tin</div>
                            <h4 style={{ fontWeight: "500" }}>{postInfo.filter(item => formData.options === item.option)[0].type}</h4>
                        </div>
                        <div
                            style={{
                                display: "flex",
                        ...
                        >
                            ...
                            <h4 style={{ fontWeight: "500" }}>{formatNumber(postInfo.filter(item => formData.options === item.option)[0].price)}đ</h4>
                        </div>
                        <div
                            style={{
                                display: "flex",
                        ...
                        >
                            ...
                            <h4 style={{ fontWeight: "500" }}>{formatNumber(postInfo.filter(item => formData.options === item.option)[0].price * formData.lifeTime)}đ</h4>
                        </div>
                        <Divider />
                        <div style={{ display: "flex", justifyContent: "space-between" }}>
                            <p style={{ fontSize: "24px", fontWeight: "500" }}>Tổng tiền</p>
                            <h4 style={{ fontWeight: "500", fontSize: "24px" }}>{formatNumber(postInfo.filter(item => formData.options === item.option)[0].price * formData.lifeTime)}đ</h4>
                        </div>
                    </div>
                    <div
                        style={{
                    ...
                    >
                        ...
                        <Flex>
                            <Flex vertical style={{ marginRight: "20px" }}>
                                ...
                                <p style={{ fontSize: "20px", fontWeight: "500" }}>{formatNumber(postInfo.filter(item => formData.options === item.option)[0].price * formData.lifeTime)}đ</p>
                            </Flex>
                            <Button
                                style={{

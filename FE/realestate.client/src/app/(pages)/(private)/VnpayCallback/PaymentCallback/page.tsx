'use client';
import { getAllTransaction, rechangeWallet, walletInfo } from '@/services/wallet/wallet.service';
    ...
    return (
        <div>
            {isSuccess ?
                <Result
                    status="success"
                    title={"Giao dịch thành công " + new Intl.NumberFormat('en-US', { style: 'currency', currency: 'VND' }).format(vnp_Amount) + "VNĐ."}
                    subTitle={"Giao dịch số: " + vnp_TransactionNo + " từ " + vnp_BankCode + " bằng " + vnp_CardType + " thành công, cảm ơn quý bạn." + " Số dư hiện tại: " + <br/> + new Intl.NumberFormat('en-US', { style: 'currency', currency: 'VND' }).format(balance) + "VNĐ."}
                    extra={[
                        <Button key="console">Trở về</Button>,
                        <Button type="primary" key="buy">Nạp thêm</Button>,
                    ]}
                >
                ...
                <Result
                    ...
                    subTitle={"Giao dịch số: " + vnp_TransactionNo + " từ " + vnp_BankCode + " bằng " + vnp_CardType + " thất bại, vui lòng thử lại."}
                    extra={[
                        <Button key="console">Trở về</Button>,
                        <Button type="primary" key="buy">Nạp lại</Button>,
                    ]}
                ></Result>
            }
        </div>
